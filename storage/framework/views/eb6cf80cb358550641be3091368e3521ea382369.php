...
<meta property="og:image" content="<?php echo e(asset('assets/front/img/'.$product->image)); ?>" />
                ...
                <div class="col-lg-8 wow fadeInLeft" data-wow-duration="1s">
                    <div class="projects_details_contect">
                        <div class="projects_details_img">
                            <img src="<?php echo e(asset('assets/front/img/'.$product->image)); ?>" alt="project" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-lg-4 wow fadeInRight" data-wow-duration="1s">
                    <div id="sticky_sidebar" class="sidebar">
                        <div class="sidebar_project_info">
                            ...
                            <ul class="list">
                                <li><span>মূল্য :</span> <?php echo e(Helper::showCurrencyPrice($product->current_price)); ?></li>
                                <li><span>লারাভেল ভার্শন :</span> <?php echo e($product->laravel_version); ?></li>
...
<ul class="btn">
<li><a class="demo" href="<?php echo e($product->demo); ?>" target="_blank">ডেমো</a></li>
<li><a class="download" href="<?php echo e($product->purchase_link); ?>" target="_blank">এখুনি কিনুন</a></li>
</ul>
</div>
                        </div>
                    </div>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softhostbd/public_html/core/resources/views/front/product/details.blade.php ENDPATH**/ ?>