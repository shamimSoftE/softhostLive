                    ...
                    <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="category_id" class="col-sm-2 control-label">{{ __('Menu Category') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @if ($errors->has('menu_category_id'))
                                                <p class="text-danger"> {{ $errors->first('menu_category_id') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                                                 ...
                                                                 <div class="form-group row">
                                        <label for="laravel_version" class="col-sm-2 control-label">{{ __('Laravel Version') }}<span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="laravel_version" placeholder="{{ __('Laravel Version') }}" value="{{ old('laravel_version') }}">
                                            @if ($errors->has('laravel_version'))
                                                <p class="text-danger"> {{ $errors->first('laravel_version') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                                                 ...
                                                                 <div class="form-group row">
                                        <label for="demo" class="col-sm-2 control-label">{{ __('Demo Link') }}<span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="demo" placeholder="{{ __('Demo Link') }}" value="{{ old('demo') }}">
                                            @if ($errors->has('demo'))
                                                <p class="text-danger"> {{ $errors->first('demo') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                                                 ...
                                                                 <div class="form-group row">
                                        <label for="purchase_link" class="col-sm-2 control-label">{{ __('Purchase Link') }}<span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="purchase_link" placeholder="{{ __('Purchase Link') }}" value="{{ old('purchase_link') }}">
                                            @if ($errors->has('purchase_link'))
                                                <p class="text-danger"> {{ $errors->first('purchase_link') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="sku" placeholder="{{ __('Sku') }}" value="{{ old('sku') }}">
                                            @if ($errors->has('sku'))
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-2 icheck-success">
                                            <input type="checkbox" id="is_downloadable" name="is_downloadable" value="1">
                                            <label for="is_downloadable">{{ __('Is Downloadable') }}</label>
                                        </div>
                                

                                        <div class="col-sm-10 showFile d-none">
                                    ...
                                    <div class="form-group row" id="attribute_view">
                                        <label for="file" class="col-sm-2 control-label">{{ __('Attribute') }}</label>
                                        <div class="col-sm-10 ">
                                            <input type="text" class="form-control my-2" name="attributes_title[]" placeholder="Attributes" value="">


                                            <textarea name="attributes_description[]" class="form-control" placeholder="Attribute Description"></textarea>
                                            </div>
                                    </div>


                                    <div class="form-group row">
                                        <label for="attributes_description" class="col-sm-2 control-label"></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" data-role="tagsinput" name="tags" placeholder="{{ __('Tags') }}" value="{{ old('tags') }}">
                                        </div>
                                    </div>
