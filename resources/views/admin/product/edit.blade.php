                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="menu_category_id" >
                                                ...
                                                @foreach($menuCategoryies as $cat)
                                                    <option value="{{ $cat->id }}" @if($product->menu_category_id == $cat->id) selected @endif>{{ $cat->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="laravel_version" placeholder="{{ __('Laravel Version') }}" value="{{ $product->laravel_version }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="demo" placeholder="{{ __('Demo Link') }}" value="{{ $product->demo }}">
                                            @if ($errors->has('demo'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="purchase_link" placeholder="{{ __('Purchase Link') }}" value="{{ $product->purchase_link }}">
