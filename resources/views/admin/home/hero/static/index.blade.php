...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Frontend Baner') }} </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i>{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Frontend Baner') }}</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Frontend Baner Info') }}</h3>
      ...
      <div class="form-group row">
                                        <label  class="col-sm-2 control-label">{{ __('Exprience Text') }}</label>
        
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="exprience" placeholder="{{ __('Exprience Text') }}" value="{{ $static->exprience }}">
                                            @if ($errors->has('exprience'))
                                                <p class="text-danger"> {{ $errors->first('exprience') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @endif
								                                    ...
								                                    <div class="form-group row">
                                        <label  class="col-sm-2 control-label">{{ __('Youtube Video Embed Code') }}</label>
        
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="youtube_video" placeholder="{{ __('Youtube Video Embed Code') }}" value="{{ $static->youtube_video }}">
                                            @if ($errors->has('youtube_video'))
                                                <p class="text-danger"> {{ $errors->first('youtube_video') }} </p>
                                            @endif
                                        </div>
                                    </div>
