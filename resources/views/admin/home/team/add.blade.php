                    ...
                    <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group row">
                                        <label for="skill1" class="col-sm-2 control-label">{{ __('Skill Titile 1') }}</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill1" placeholder="{{ __('Skill Tittle 1') }}" value="{{ old('skill1') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill1_text" placeholder="{{ __('Skill Text 1') }}" value="{{ old('skill1_text') }}">
                                            ...
                                            @endif
																	...
																	<div class="form-group row">
                                        <label for="skill2" class="col-sm-2 control-label">{{ __('Skill Titile 2') }}</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill2" placeholder="{{ __('Skill Tittle 2') }}" value="{{ old('skill2') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill2_text" placeholder="{{ __('Skill Text 2') }}" value="{{ old('skill2_text') }}">
                                            ...
                                            @endif
																										...
																										<div class="form-group row">
                                        <label for="skill3" class="col-sm-2 control-label">{{ __('Skill Titile 3') }}</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill3" placeholder="{{ __('Skill Tittle 3') }}" value="{{ old('skill3') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill3_text" placeholder="{{ __('Skill Text 3') }}" value="{{ old('skill3_text') }}">
                                            ...
                                            @endif
																																		...
																																		<div class="form-group row">
                                        <label for="skill4" class="col-sm-2 control-label">{{ __('Skill Titile 4') }}</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill4" placeholder="{{ __('Skill Tittle 4') }}" value="{{ old('skill4') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill4_text" placeholder="{{ __('Skill Text 4') }}" value="{{ old('skill4_text') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill_tittle" placeholder="{{ __('Skill Tittle') }}" value="{{ old('skill_tittle') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skill_subtittle" placeholder="{{ __('Skill Sub Tittle') }}" value="{{ old('skill_subtittle') }}">
