                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @endif
                                                                        ...
                                                                        <div class="form-group row">
                                        <label for="title" class="col-sm-2 control-label">Short Details<span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                                <textarea name="short_details" class="form-control summernote" id="ck" rows="6" placeholder="Short Details">{{ old('short_details') }}</textarea>
                                            @if ($errors->has('short_details'))
                                                <p class="text-danger"> {{ $errors->first('short_details') }} </p>
                                            @endif
                                        </div>
                                    </div>
