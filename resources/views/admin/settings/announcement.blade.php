                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.update_announcement', $st->language_id ) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $visibility->is_announcement == '1' ? 'checked' : '' }} data-size="large" name="is_announcement" data-bootstrap-switch data-off-color="danger" data-on-color="primary" data-on-text="Active" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Dactive">
