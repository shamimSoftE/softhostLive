            ...
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Website Customization', $permissions)))
                    <li class="nav-item has-treeview
                        ...
                        @elseif(request()->path() == 'admin/category') menu-open
                        @elseif(request()->path() == 'admin/sub_category') menu-open 
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('admin/category') }}"
                                    class="nav-link @if(request()->path() == 'admin/category') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Menu Category') }}</p>
                                </a>
                            </li>
                            
                            <li class="nav-item">
                                <a href="{{ url('admin/sub_category') }}"
                                    class="nav-link @if(request()->path() == 'admin/sub_category') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ __('Menu Sub Category') }}</p>
                                </a>
                            </li>
