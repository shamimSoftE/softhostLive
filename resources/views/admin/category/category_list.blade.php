                    ...
                    <div class="col-xl-5 col-md-5 col-sm-12 col-12">
                        <div class="card" style="min-height:200px;">
                            ...
                            <div class="card-body pb-0 pt-2">
                                <form class="blogCateForm" action="{{ url('admin/category_store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group mb-0">
                                                <label for="title" class="form-label">Name</label>
                                                <input type="text" class="form-control" style="height:31px;" required name="name" value="{{ old('name') }}" placeholder="">
                                            </div>
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Name</th>
                                                 <th>Type</th>
                                                <!--<th>{{ session('lang') == 'EN' ? 'Image' : 'Image' }}</th>-->
