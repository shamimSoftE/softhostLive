...
<meta property="og:image" content="{{ asset('assets/front/img/'.$setting->breadcrumb_image) }}" />
  <!-- Meta Pixel Code -->
<script>
...
@section('content')
 ...
 <!--==============================
        BANNER START
    ===============================-->
    <section class="banner" style="background: url({{ asset('assets/front/img/'.$sinfo->hero_bg_image ) }}) no-repeat center/cover;">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="banner_content">
                        <h3>{{ $sinfo->exprience }}</h3>
                        <h1>{{ $sinfo->hero_title }}</h1>
                        <p class="description">{{ $sinfo->hero_text }}
                        </p>
                        <div class="banner_btn d-flex flex-wrap">
                            <a href="{{ URL::to('/gate-a-quote') }}" class="common_btn">ফ্রি কনসালটেশন</a>
                            <a class="venobox play_btn" data-autoplay="true" data-vbtype="video"
                                href="https://youtu.be/{{ $sinfo->youtube_video }}">
                ...
                <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1s">
                    <div class="banner_img">
                        <img src="{{ asset('assets/front/img/'.$sinfo->hero_image) }}" alt="banner-img" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="about_img_box">
                        <div class="small_img">
                            <img src="{{ asset('assets/front/img/'.$sinfo->about_image1) }}" alt="image" class="img-fluid w-100">
                        </div>
                        <div class="main_img">
                            <img src="{{ asset('assets/front/img/'.$sinfo->about_image) }}" alt="image" class="img-fluid w-100">
                        </div>
                        <div class="support_img">
                            <img src="{{ asset('assets/front/img/'.$sinfo->about_image2) }}" alt="image" class="img-fluid w-100">
                            <div class="item_card">
                                <span>
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s">
                    <div class="section_heading pt_35">
                        <h3>{{ $sinfo->about_title }}</h3>
                        <h2>{{ $sinfo->about_sub_title }}</h2>
                    </div>
                        ...
                        <div class="grid_item">
                            <div class="left">
                                <div class="experience">
                                    ...
                                    <p>{{ $sinfo->about_experince_yers }} বছরের পরামর্শের <span>অভিজ্ঞতা</span></p>
                                </div>
                                <ul>
                                    <li>{{ $sinfo->about_tiitle_1 }}</li>
                                    <li>{{ $sinfo->about_tiitle_2 }}</li>
                                    <li>{{ $sinfo->about_tiitle_3 }}</li>
                                </ul>
                                <a class="common_btn" href="{{ URL::to('/gate-a-quote') }}">ফ্রি কনসালটেশন</a>
                            </div>
                            <div class="right">
                                <div class="counter_item">
                                    <h4>{{ $sinfo->sucess_rate }}</h4>
                                    <p>সফলতার রেট</p>
                                </div>
                                <hr>
                                <div class="counter_item">
                                    <h4>{{ $sinfo->satisfied_client }}</h4>
				...
				<div class="col-xl-3 col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                    <div class="feature_item">
                        <div class="icon">
							...
							<img src="{{ $item->icon }}" alt="icon" class="img-fluid w-100">
			  ...
			  @foreach ($counters as $id=>$item)
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="1s">
                    <div class="achievement_item">
                        <div class="icon">
                            <span><img src="https://blogger.googleusercontent.com/img/b/{{ $item->icon }}" alt="icon" class="img-fluid w-100"></span>
                        </div>
                        <h4><span class="counter">{{ $item->number }}</span>+</h4>
                        <p>{{ $item->title }}</p>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-8 m-auto">
                    <div class="projects_filter d-flex flex-wrap">
						...
						<a href="{{ route('front.portfolio',['category'=>$item->slug]) }}">
            ...
            <div class="row grid">
			 ...
			 @foreach ($portfolios as $item)
                <div class="col-xl-3 col-sm-6 col-lg-4 .{{ $item->title }} wow fadeInUp" data-wow-duration="1s">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-sm-6 col-lg-4 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                    <div class="home_2_team_item">
                        <div class="image">
                            <span>
                                <img src="{{ asset('assets/front/img/team/'.$item->image) }}" alt="image" class="img-fluid w-100">
                            </span>
                        </div>
                        <div class="text">
                            <ul>
						...
						@if($item->url2 && $item->icon2)
						 ...
						 @endif
                            ...
                            <a class="link" href="{{ route('front.team_details', $item->id) }}">{{ $item->name }}</a>
                            <p>{{ $item->dagenation }}</p>
                        </div>
                    </div>
                </div>
...
<section class="home_2_testimonial pt_115 xs_pt_75 pb_120 xs_pb_80"
        style="background: url({{ asset('assets/frontend') }}/images/testimonial_2_bg.png);">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 m-auto">
                    <div class="section_heading">
            ...
            <div class="row home_2_team_slider">
				...
				<div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                    <div class="home_2_single_team">
                        <span>
                            <img src="{{ asset('assets/front/img/'.$item->image) }}" alt="image" class="img-fluid w-100">
                        </span>
                        <p>{{ $item->message }}</p>
    ...
    <section class="blog pt_115 xs_pt_75 pb_115 xs_pb_75">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 m-auto">
                    <div class="section_heading pb_20">
                        <h3>{{ $sinfo->blog_title }}</h3>
                        <h2>{{ $sinfo->blog_sub_title }}</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                    <div class="single_blog">
                        ...
                        <div class="single_blog_text">
                            ...
                            <p>{!! (strlen(strip_tags(Helper::convertUtf8($item->short_details))) > 100) ? substr(strip_tags(Helper::convertUtf8($item->short_details)), 0, 120) . '...' : strip_tags(Helper::convertUtf8($item->short_details)) !!}</p>
                    ...
                    <div class="marquee_animi">
                        <ul class="brand_logo_area d-flex flex-wrap justify-content-between">
						 @foreach ($clients as $item)
                            <li><a href="{{ $item->link }}"><img src="{{ asset('assets/front/img/client/'.$item->image) }}" alt="brand" class="img-fluid w-100"></a></li>
							@endforeach
                        </ul>
                    </div>
                </div>
