...
class FrontendController extends Controller
{
    ...
    public function index(){
        ...
        $data['all_services'] = Service::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(4)->get();
		 $data['my_services'] = Service::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(8)->get();
		 $data['portfolios'] = Portfolio::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(8)->get();
    ...
    public function faq() {
        ...
        $services= Service::where('status',1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(6)->get();

        
		
		
		$faqs = Faq::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(5)->get();
        $faqs1 = Faq::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->skip(5)->limit(6)->get();
		
		return view('front.faq', compact('faqs','services','faqs1'));
    }
...
$data['portfolios'] = Portfolio::where('status', 1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(8)->get();
        ...
        $data['portfolio_images'] = PortfolioImage::where('portfolio_id', $data['portfolio']->id)->limit(1)->get();
        $data['services'] = Service::where('status',1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(6)->get();
...
$data['services'] = Service::where('status',1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(6)->get();
    ...
    public function team() {
        ...
        $data['teams'] = Team::where('language_id', $currlang->id)->where('status',1)->orderBy('serial_number', 'asc')->paginate(100);
$data['services'] = Service::where('status',1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(6)->get();
        return view('front.team', $data);
    }

    public function team_details($id){
        $services= Service::where('status',1)->where('serial_number', 'asc')->limit(6)->get();
	$teams= Team::where('status',1)->orderBy('serial_number', 'asc')->paginate(100);
        $team = Team::find($id);
        return view('front.team-details', compact('team','services','teams'));
    }
...
$services= Service::where('status',1)->where('language_id', $currlang->id)->orderBy('serial_number', 'asc')->limit(6)->get();
        $blogs = Blog::where('status', 1)->where('language_id', $currlang->id)
                        ...
                        ->orderBy('serial_number', 'asc')->paginate(20);

        return view('front.blogs', compact('blogs', 'bcategories','services','latestblogs', 'archives'));
    }
    ...
    public function blogdetails($slug) {
        ...
        return view('front.blogdetails', compact('blog', 'bcategories','services', 'latestblogs', 'archives'));
    }
