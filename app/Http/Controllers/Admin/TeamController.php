...
class TeamController extends Controller
{
    ...
    public function store(Request $request){
		...
		$team->skill1 = $request->skill1;
		$team->skill1_text = $request->skill1_text;
		$team->skill2 = $request->skill2;
		$team->skill2_text = $request->skill2_text;
		$team->skill3 = $request->skill3;
		$team->skill3_text = $request->skill3_text;
		$team->skill4 = $request->skill4;
		$team->skill4_text = $request->skill4_text;
		$team->skill_tittle = $request->skill_tittle;
		$team->skill_subtittle = $request->skill_subtittle;
