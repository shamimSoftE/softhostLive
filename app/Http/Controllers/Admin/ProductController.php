...
class ProductController extends Controller
{
    ...
    public function add(){
        $productCategoryies = ProductCategory::where('status', 1)->get();
        $categoryies = Category::where('status', 1)->get();
    ...
    public function store(Request $request){
		...
		$product->laravel_version= $request->laravel_version;
    ...
    public function edit($id){
        ...
        $menuCategoryies = Category::where('status', 1)->get();
        return view('admin.product.edit', compact('product', 'categoryies', 'menuCategoryies'));
