...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::get('/dashboard', 'Admin\DashboardController@dashboard')->name('admin.dashboard');
        ...
        Route::get('category_getList', [CategoryController::class, 'categoryGet']);
        Route::post('category_store', [CategoryController::class, 'store']);
        Route::get('category_edit', [CategoryController::class, 'edit']);
        ...
        Route::get('get_sub_category', [subCategoryController::class, 'subCategoryGet']);
        Route::post('sub_category_store', [subCategoryController::class, 'store']);
        Route::post('sub_category_update', [subCategoryController::class, 'update']);
        Route::post('sub_category_destroy', [subCategoryController::class, 'destroy']);
